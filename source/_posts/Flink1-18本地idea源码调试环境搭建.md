...
搭建 Flink 1.18 的本地源码调试环境，可以帮助我们更深入地理解其内部机制，高效定位和解决问题。本文将详细介绍在 Windows 系统下，使用 IntelliJ IDEA 搭建 Flink 1.18 源码调试环境的步骤。
...
至此，Flink 1.18 的本地源码调试环境已基本搭建完成。您可以在 IDEA 中对 Flink 的核心代码设置断点，提交示例作业进行调试，从而更深入地学习和理解 Flink 的运行机制。祝您调试愉快！
